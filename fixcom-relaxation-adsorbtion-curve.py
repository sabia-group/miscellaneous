...
constraints.append(FixGroupCom(indices=range(0,6)+range(12,24)))  # that's how atoms are organized in geometry.initial.in
constraints.append(FixGroupCom(indices=range(6,12)+range(24,36))) #
atoms.set_constraint(constraints)
